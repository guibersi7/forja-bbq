...
export function Hero() {
  return (
    ...
    >
      ...
      {/* Glow effect — hidden on mobile to save GPU */}
      <div className="hidden md:block absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[800px] h-[800px] bg-accent-fire/5 rounded-full blur-[150px]" />

      {/* Content */}
      <div className="relative z-10 w-full px-4 py-20">
        <div className="max-w-6xl mx-auto flex flex-col items-center">
          {/* Logo — native img for fastest LCP, no JS needed */}
