...
const ADDRESS =
  "Estrada do Ipatinga - travessa, 6, 231 - Bairro do Ipatinga, Sorocaba - SP, 18053-400";
  ...
  return (
    ...
    >
      <div className="max-w-6xl mx-auto px-4">
        <ScrollReveal duration={800} className="text-center mb-16">
        ...
        <div className="grid lg:grid-cols-2 gap-8">
          {/* Google Maps Embed */}
          <ScrollReveal duration={800} delay={200}>
            <div className="aspect-square lg:aspect-auto lg:h-[500px] bg-bg-secondary rounded-2xl overflow-hidden relative">
              <iframe
                src={embedUrl}
                width="100%"
                height="100%"
          ...
          {/* Info cards */}
          <ScrollReveal direction="right" distance={30} duration={800} delay={400}>
